...
def program(base_params, csv_path, n_tests=1, models_to_test=None, save_results=False, run_options={"rt":False,"it":False, "lt":False, "nt":False}, impact_models_to_test=None, k=3, lengthscale_list=None, db_path="wyniki_testow.csv", visualise=False, nemenyi_params=None, **kwargs):
